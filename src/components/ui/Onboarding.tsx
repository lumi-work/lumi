...
import OnboardingLogo from "../../../public/logo.svg";
  ...
  const pages = [
    {
      ...
      content:
        "You're about to dive into Lumi, a simple and efficient to-do and board system. Let's get started!",
      ...
      <div className="bg-white w-[470px] h-[440px] rounded-3xl p-8 shadow-lg flex-col items-center overflow-hidden">
        ...
        <div className="mt-auto flex justify-between w-full pt-2">
          {currentPage < pages.length - 1 && (
            <button
              onClick={handleNext}
              className="bg-gray-900 px-5 py-1.5 text-white rounded-lg hover:bg-gray-800"
            >
              Next
            </button>
          )}
          ...
          {currentPage === pages.length - 1 && (
            <button
              ...
              className="bg-[#4B4EE7] px-5 py-1.5 text-white rounded-lg hover:bg-[#5b5eef]"
            >
              Finish
            </button>
          )}
        ...
        <div className="flex items-center justify-center gap-1 mb-4 pt-10">
          <div
            className={`w-2 h-2 rounded-full ${
              currentPage >= 0 ? "bg-gray-700" : "bg-gray-300"
            }`}
          ></div>
          <div
            className={`w-2 h-2 rounded-full ${
              currentPage >= 1 ? "bg-gray-700" : "bg-gray-300"
            }`}
          ></div>
          <div
            className={`w-2 h-2 rounded-full ${
              currentPage >= 2 ? "bg-gray-700" : "bg-gray-300"
            }`}
          ></div>
          <div
            className={`w-2 h-2 rounded-full ${
              currentPage >= 3 ? "bg-gray-700" : "bg-gray-300"
            }`}
          ></div>
        </div>
      </div>
